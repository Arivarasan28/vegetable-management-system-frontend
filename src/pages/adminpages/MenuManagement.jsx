...
//       className="min-h-screen bg-black text-green-700 flex flex-col justify-center items-center bg-cover bg-center px-4 pt-[10px]"
//     >
//       <div className="flex items-center justify-between w-full mb-4">
...
const VegetableManagement = () => {
  ...
  return (
    <section
      id="vegetablemanagement"
      className="min-h-screen bg-black text-green-700 flex flex-col items-center bg-cover bg-center px-4 pt-[10px]"
    >
      <div className="flex items-center justify-between w-full mb-4">
        <h1 className="text-2xl font-bold">VEGETABLES</h1>
